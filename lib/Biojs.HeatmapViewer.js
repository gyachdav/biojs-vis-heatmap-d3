...
var HeatmapViewer;
module.exports = HeatmapViewer = Class(
    ...
    this._origData = options.jsonData;
	...
	eventTypes: [
       ...
       with the names defined here. Use this.trigger(<eventName>,
...
Events.mixin(HeatmapViewer.prototype);
